...
group_params() {
    case "$1" in
        ...
        B_debt_adaptive)        echo "false ${HEUR_COEF} none   0.5  ${SERVICE_DEBT_THRESHOLD:-5} ${SERVICE_DEBT_ACTION_BOOST:-0.15} ${SERVICE_DEBT_REWARD_COEF:-0.75} ${SERVICE_DEBT_MAX_FRAMES:-20} ${SERVICE_DEBT_REQUEST_BUDGET:-5.0} ${SERVICE_DEBT_BUDGET_BOOST:-3.0} true true false" ;;
